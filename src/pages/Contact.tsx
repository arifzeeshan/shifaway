    ...
    <div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12 overflow-hidden rounded-3xl bg-[#047857] p-6 text-white shadow-xl sm:p-8">
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              <div className="max-w-2xl">
                <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-[#f4c542]/40 bg-[#f4c542]/15 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-[#f4c542]">
              ...
              <a
                ...
                className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl bg-[#f4c542] px-6 py-3 text-sm font-black uppercase tracking-wider text-[#064e3b] transition-colors hover:bg-[#d9a520]"
              >
            ...
            <div>
              ...
              <div className="mb-8">
                ...
                <div className="flex gap-3">
                  ...
                  <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center hover:border-[#f4c542] hover:text-[#f4c542] text-gray-500 transition-colors">
                    <Twitter size={18} />
                  </a>
                  <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center hover:border-[#f4c542] hover:text-[#f4c542] text-gray-500 transition-colors">
                    <Linkedin size={18} />
                  </a>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="contact-full-name" className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">{t('contact.fullName')}</label>
                    <input
                  ...
                  <div>
                    <label htmlFor="contact-email" className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">{t('contact.emailAddress')}</label>
                    <input
                      id="contact-email"
                      type="email"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="contact-phone" className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">{t('contact.phoneNumber')}</label>
                    <input
                      id="contact-phone"
                      type="tel"
                  ...
                  <div>
                    <label htmlFor="contact-country" className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">{t('contact.country')}</label>
                    <input
                      id="contact-country"
                      type="text"
                ...
                <div>
                  <label htmlFor="contact-treatment-type" className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">{t('contact.treatmentType')}</label>
                  <select
                ...
                <div>
                  <label htmlFor="contact-message" className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">{t('contact.yourMessage')}</label>
                  <textarea
                    id="contact-message"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex w-full items-center justify-center gap-2 rounded-lg border border-[#047857]/20 bg-[#047857]/5 py-3 text-sm font-bold uppercase tracking-wider text-[#047857] transition-colors hover:bg-[#047857] hover:text-white"
                >
                ...
                <div className="flex items-start gap-2 rounded-xl bg-gray-50 p-3 text-xs leading-relaxed text-gray-500">
                  <ShieldCheck size={16} className="mt-0.5 shrink-0 text-[#047857]" />
